<!DOCTYPE html>
<html>
<title> Pannel de création d'Admin </title>
...
<div class="w3-container">
  <h2> Panel de création d'Admin </h2>
	<th>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <form class="w3-container" action="" method="post">
        <div class="w3-section">
          ...
          <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder=" Admin " name="usrname" required>
